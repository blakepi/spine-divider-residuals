...
Earlier reviewer-access packages established manifest and checksum workflows. The finalization package supersedes those approval-gated drafts with an approved public-release staging repository and journal-specific submission bundle; authenticated GitHub upload and Zenodo DOI minting remain technical manual steps, not scientific or PI-approval blockers.
